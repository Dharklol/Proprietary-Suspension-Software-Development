...
SOURCE = ROOT / "data_catalog/wufr27_static_equilibrium_composition_v1.toml"
...
class WUFRStaticEquilibriumTests(unittest.TestCase):
    ...
    def test_source_and_numerical_contract_are_explicit(self) -> None:
        ...
        self.assertEqual(self.provider.quasi_static_config.residual_absolute_tolerance, 2.0e-10)
        self.assertEqual(self.provider.quasi_static_config.residual_relative_tolerance, 2.0e-10)
        ...
        self.assertEqual(self.provider.rocker_derivative.coordinate_mode, "internal_qL")
        self.assertEqual(self.provider.road_contact.config.road_gap_tolerance_m, 1.0e-13)
        self.assertEqual(self.provider.road_contact.config.physical_q_L_tolerance_rad, 1.0e-14)
        self.assertEqual(
            self.provider.road_contact.config.kinematics_length_residual_tolerance_m,
            1.0e-14,
        )
