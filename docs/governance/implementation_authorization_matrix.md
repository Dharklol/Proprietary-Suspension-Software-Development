...
Nonzero OptimumK wheel-offset semantics, generic tire/contact geometry, actuation linkage, roll center/anti geometry, forces, compliance, physical joint limits, packaging, whole-vehicle source placement, and installed/as-built validation remain separate authorization problems.
