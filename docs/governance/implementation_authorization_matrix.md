...
Nonzero OptimumK wheel-offset semantics, generic tire/contact geometry, roll center/anti geometry, spring/damper forces, wheel rate/damping, anti-roll-bar coupling, load transfer/equilibrium, compliance, physical joint limits, packaging, whole-vehicle source placement, installed/as-built validation, and production optimization remain separate authorization problems.
